...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/xzxxxzzz/Approval/blob/main/Approval').text
        ua=open('bbnew.txt','w')
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/xzxxxzzz/Approval/blob/main/Approval').text
    if id in httpCaht:
      print(fuckyoursali)
